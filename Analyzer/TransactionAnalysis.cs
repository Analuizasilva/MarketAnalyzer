...
//    {
//        public CompanyTransactions GetUserCompanyTransactions(List<UserTransaction> userTransactions, Guid companyId) //para um user, obter o portfolio das várias transações para uma empresa
//        {
