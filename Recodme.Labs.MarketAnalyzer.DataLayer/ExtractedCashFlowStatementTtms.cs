...
{
    public class ExtractedCashFlowStatementTtms:Entity
    {
        ...
        public ExtractedCashFlowStatementTtms()
        {
        }

        public ExtractedCashFlowStatementTtms(Guid id, DateTime createdAt, DateTime updatedAd) : base(id, createdAt, updatedAd)
        {
        }
    }
}
