...
{
    public class ExtractedIncomeStatementTtm : Entity
    {
        ...
        public ExtractedIncomeStatementTtm()
        {
        }

        public ExtractedIncomeStatementTtm(Guid id, DateTime createdAt, DateTime updatedAd) : base(id, createdAt, updatedAd)
        {
        }
    }
}
