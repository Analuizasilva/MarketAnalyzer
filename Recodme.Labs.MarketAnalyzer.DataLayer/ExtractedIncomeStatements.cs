...
{
    public class ExtractedIncomeStatements : Entity
    {
        ...
        public ExtractedIncomeStatements()
        {
        }

        public ExtractedIncomeStatements(Guid id, DateTime createdAt, DateTime updatedAd) : base(id, createdAt, updatedAd)
        {
        }
    }
}
