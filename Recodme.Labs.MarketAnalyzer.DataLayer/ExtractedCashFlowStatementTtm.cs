...
{
    public class ExtractedCashFlowStatementTtm : Entity
    {
        ...
        public ExtractedCashFlowStatementTtm()
        {
        }

        public ExtractedCashFlowStatementTtm(Guid id, DateTime createdAt, DateTime updatedAd) : base(id, createdAt, updatedAd)
        {
        }
    }
}
