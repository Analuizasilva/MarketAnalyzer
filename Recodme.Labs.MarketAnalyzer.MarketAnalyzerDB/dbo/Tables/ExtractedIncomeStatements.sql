CREATE TABLE [dbo].[ExtractedIncomeStatements] (
    ...
    CONSTRAINT [PK_ExtractedIncomeStatements] PRIMARY KEY CLUSTERED ([Id] ASC),
    CONSTRAINT [FK_ExtractedIncomeStatements_Companies] FOREIGN KEY ([CompanyId]) REFERENCES [dbo].[Companies] ([Id]),
    CONSTRAINT [FK_ExtractedIncomeStatements_DataSources] FOREIGN KEY ([DataSourceId]) REFERENCES [dbo].[DataSources] ([Id])
);
